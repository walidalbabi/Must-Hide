...
public class Inok : MonoBehaviourPun
{
    ...
    {
        PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "Monsters", "Abilities", "HealArea"), transform.position, Quaternion.identity);
    }
