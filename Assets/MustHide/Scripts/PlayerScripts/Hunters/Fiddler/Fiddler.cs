...
public class Fiddler : MonoBehaviour
{
    ...
    private void IfAbility()
    {
       // StartCoroutine(GetComponent<ShootingScript>()._MuzzleFlash());
        GameObject Bullet = PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "Hunters", "Abilities", "BulletTracker"), Muzzle.position, Muzzle.rotation);
